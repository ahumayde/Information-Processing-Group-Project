...
# Memory: dram_controller
MEM_0 := dram_controller
$(MEM_0)_NAME := dram_controller
...
$(MEM_0)_HIERARCHICAL_PATH := dram_controller
$(MEM_0)_WIDTH := 16
$(MEM_0)_HEX_DATA_WIDTH := 16
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: dram_controller
dram_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
